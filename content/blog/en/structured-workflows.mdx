...
To delegate the assignment to a separate conversation, continue with [DSH Session Conductor's task and result-return workflow](/en/blog/dsh-session-conductor) and use this brief as its initial instruction.

For reading material and organizing study notes, see [Conuo's source questions and knowledge-page review workflow](/en/blog/conuo) and make source scope, verification, and saving explicit steps in the brief.
